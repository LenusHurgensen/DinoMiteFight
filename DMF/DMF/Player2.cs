...
namespace DMF
{
    class Player2
    {
        ...
        {
            leftWallk = Content.Load<Texture2D>("LeftTextureP2");
            rightWalk = Content.Load<Texture2D>("RightTextureP2");
        ...
        public void Input(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.RightControl) && hasJumped == false)
            {
                position.Y -= 5f;
                velocity.Y = -10f;
                hasJumped = true;
